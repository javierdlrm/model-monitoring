...
case class JobConfig(timeout: Int, source: StreamConnectorConfig, sink: StreamConnectorConfig)

object JobConfig {
  implicit val decodeJobConfig: Decoder[JobConfig] = Decoder.forProduct3("timeout", "source", "sink")(JobConfig.apply)
