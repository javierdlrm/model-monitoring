 ...
 */
object IrisMLBuiltInStatsMonitoring {
  ...
  def main(args: Array[String]): Unit = {
    ...
    LoggerUtil.log.info(s"[BuiltInMonitoring] Starting job...")
    ...
    // EXCEPTION: org.apache.spark.sql.AnalysisException: Queries with streaming sources must be executed with writeStream.start();;
    ...
    // Close session
    LoggerUtil.log.info("[BuiltInMonitoring] Shutting down spark job...")
    spark.close()
  }
